...
import { a as findIonContent, p as printIonContentErrorMsg, g as getScrollElement } from './index-b0116568.js';
  ...
  componentDidLoad() {
    {
      rIC(async () => {
        ...
        if (config.getBoolean('statusTap', isHybrid)) {
          import('./status-tap-52d42f39.js').then((module) => module.startStatusTap());
        }
        if (config.getBoolean('inputShims', needInputShims())) {
          import('./input-shims-9f58f9e5.js').then((module) => module.startInputShims(config));
        }
